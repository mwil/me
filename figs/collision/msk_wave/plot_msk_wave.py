...
axes.append(fig.add_subplot('311', aspect=1.5))
axes.append(fig.add_subplot('312', aspect=1.5))
axes.append(fig.add_subplot('313', aspect=1.5))
...
axes[2].set_title('Passband signal $s(t)$')
...
axes[0].plot(t[::mark_skip], s_i[::mark_skip], '^', ms=2, c='0.4')
axes[0].plot(t, a_i*cos(t*omega_p), c='0.7')
axes[0].plot(t[::mark_skip], (a_i*cos(t*omega_p))[::mark_skip], 'o', ms=2, c='0.7')

axes[1].plot(t, a_q, c='0.0')
axes[1].plot(t, s_q, c='0.4')
axes[1].plot(t[::mark_skip], s_q[::mark_skip], '^', ms=2, c='0.4')
axes[1].plot(t, a_q*sin(t*omega_p), c='0.7')
axes[1].plot(t[::mark_skip], (a_q*sin(t*omega_p))[::mark_skip], 'o', ms=2, c='0.7')

axes[2].plot(t, s_i + s_q, c='0.1')

#plt.savefig('pdf/msk_wave.pdf')
plt.savefig('png/msk_wave.png', dpi=100)
